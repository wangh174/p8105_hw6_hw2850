...
birthwt = read_csv("data/birthweight.csv") %>% 
  janitor::clean_names()
```
Interested in investigating the relationship between birthweight and family monthly income (fincome) and mother's weight at delivery (delwt) as a confounder.
